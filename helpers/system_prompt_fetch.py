from helpers.db_connection_handler import DbConnectionHandler

async def system_prompt_fetch(recognized_speaker, user_emotion):
    """Dynamically fetches system prompts from the database, including system-level instructions."""

    db_helper = DbConnectionHandler()
